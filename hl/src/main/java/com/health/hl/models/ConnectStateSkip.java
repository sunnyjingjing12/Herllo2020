 ...
 * 2015/4/27
 */
public class ConnectStateSkip {
	
    private String device_name;
    private  String device_address;

    public static final String PREFS_NAME = "com.sayes.sayesskip.models.connect-state";

    public  static  final  String DEVICE_NAME ="device-name";
    public  static  final  String DEVICE_ADDRESS ="device-address";


    private static ConnectStateSkip state;

    private ConnectStateSkip() {
        reload();
    }

    public static ConnectStateSkip get() {

        if (state == null) {
            state = new ConnectStateSkip();
        }
