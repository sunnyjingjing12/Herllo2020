 ...
 * 
 */
public class AnfeiAboutDialog extends Dialog {
...
//	private App app;
	...
	public AnfeiAboutDialog(Context context, String title_name) {
		super(context,R.style.DialogStyleRecover);
		this.context = context;
//		this.app = app;
		this.title_name = title_name;
	}
//	public AnfeiAboutDialog(Context context, String title_name,int style) {
//		super(context,style);
//		this.context = context;
////		this.app = app;
//		this.title_name = title_name;
//	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dialog_anfei_about);
		// 设置标题
		setTitle(title_name);
//		Button BtnCancel = (Button) findViewById(R.id.btn_dialog_cancel);
//		BtnCancel.setOnClickListener(clickListener);
		Button BtnRescan = (Button) findViewById(R.id.btn_dialog_rescan);
