 ...
 * 2015/4/27
 */
public class ConnectStateBracelet {
	
    private String device_name;
    private  String device_address;

    public static final String PREFS_NAME = "com.sayes.sayesbracelet.models.connect-state";

    public  static  final  String DEVICE_NAME ="device-name";
    public  static  final  String DEVICE_ADDRESS ="device-address";


    private static ConnectStateBracelet state;

    private ConnectStateBracelet() {
        reload();
    }

    public static ConnectStateBracelet get() {

        if (state == null) {
            state = new ConnectStateBracelet();
        }
