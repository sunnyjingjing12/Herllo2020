 ...
 * 2015/4/27
 */
public class ConnectStateAnfei {
	
    private String device_name;
    private  String device_address;

    public static final String PREFS_NAME = "com.sayes.sayesanfei.models.connect-state";

    public  static  final  String DEVICE_NAME ="device-name";
    public  static  final  String DEVICE_ADDRESS ="device-address";


    private static ConnectStateAnfei state;

    private ConnectStateAnfei() {
        reload();
    }

    public static ConnectStateAnfei get() {

        if (state == null) {
            state = new ConnectStateAnfei();
        }
